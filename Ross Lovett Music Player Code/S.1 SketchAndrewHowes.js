...
function draw() {
    ...
    rect(50, 50, 250, 250)       // Andrew Howes "May Day" Album Art (Resized)
    
    
    rect(50, 350, 250, 50)       // Andrew Howes "Nine Stones" Track Name (Text) and button to play track when clicked
    
    rect(50, 450, 250, 50)       // Andrew Howes "Spinning In A Green Field" Track Name (Text) and button to play track when clicked
    
    rect(50, 550, 250, 50)       // Andrew Howes "Stolen Car" Track Name (Text) and button to play track when clicked
