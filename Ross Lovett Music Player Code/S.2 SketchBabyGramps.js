...
function draw() {
    ...
    rect(50, 50, 250, 250)       // Baby Gramps "Live at WFMU" Album Art (Resized)
    
    
    rect(50, 350, 250, 50)       // Baby Gramps "Nothin But a Nothin" Track Name (Text) and button to play track when clicked
    
    rect(50, 450, 250, 50)       // Baby Gramps "Only The Moonman Knows" Track Name (Text) and button to play track when clicked
    
    rect(50, 550, 250, 50)       // Baby Gramps "Palindrome Song" Track Name (Text) and button to play track when clicked
